    ...
    <>
      {
        dados.map((card, index) => (
          <section  key={index} className='pilotosContainer'>
            <section class="m-28 grid grid-cols-3">
              <div class="grid grid-rows-3">
                <div>
                  <h3 class="text-xl text-5xl mb-6 ">{card.nomePiloto} </h3>
                </div>
              ...
              <div class="rounded">
                <img class="w-24 lg:w-36 xl:w-72 rounded-3xl border-4 border-black" src={card.foto} />
              </div>
